        ...
        child: ListView(
          ...
          children: <Widget>[
            const UserAccountsDrawerHeader(
              accountName: Text("Student Name"), // Replace with actual student name
              accountEmail: Text("student.email@example.com"), // Replace with actual email
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const LoginPage()), // Redirects to the LoginPage
                );
              },
            ),
          ],
